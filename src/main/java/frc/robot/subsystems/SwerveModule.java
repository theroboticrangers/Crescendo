...
public class SwerveModule {
	...
	public SwerveModule(int drivingCANId, int turningCANId, int turningAnalogPort, double chassisAngularOffset) {
		...
		m_chassisAngularOffset = chassisAngularOffset; // TO DO REMOVE ALL REFS TO ANGULAR OFFSET
	...
	public SwerveModuleState getState() {
		...
		return new SwerveModuleState(m_drivingEncoder.getVelocity(),
			new Rotation2d(m_turningEncoder.getPosition() - m_chassisAngularOffset)); // TO DO REMOVE ALL REFS TO ANGULAR OFFSET
	}
	...
	public void setDesiredState(SwerveModuleState desiredState) {
		...
		correctedDesiredState.angle = desiredState.angle.plus(Rotation2d.fromRadians(m_chassisAngularOffset)); // TO DO REMOVE ALL REFS TO ANGULAR OFFSET
