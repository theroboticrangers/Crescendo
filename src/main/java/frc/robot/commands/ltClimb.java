 ...
 * will override.
 */
public class ltClimb extends Command {

  LtClimber m_ltclimber;

  /** Creates a new Left Climber. */
  public ltClimb(LtClimber ltclimber) {
  ...
  public void initialize() {
    ...
    m_ltclimber.setltClimberWheel(kltclimberupSpeed);
    System.out.println("GrabberCmd started!");
  }
  ...
  public void end(boolean interrupted) {
    ...
    m_ltclimber.stop();
    System.out.println("GrabberCmd ended!");
  }
}